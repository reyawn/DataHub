...
describe("DataHub", function defineDataHubTests() {
    ...
    it(".share ({data: ...}): Shares all JS data types asynchronously.", function testDataHub_shareAnythingAsynchronously() {
        ...
        runs(function () {
            ...
            app.share({data: Date});				//test sending enyo
        });
        ...
        runs(function () {
            expect(watcher.data).toEqual(Date);
        });
    ...
    describe("watch, then share (WS)", function () {
        it('.share ({data: ...}): Doesn\'t "keep" data or "sync"', function testDataHub_dontKeepAsyncShare_WS() {
            var watcher = new Watcher();
            spyOn(watcher, "setData").andCallThrough();
    ...
    describe("share, then watch, then share again (SWS)", function () {
        it('.share ({data: ...}): Doesn\'t "keep" data or "sync"', function testDataHub_dontKeepAsyncShare_SWS() {
            var watcher = new Watcher();
        ...
        it('.share ({data: {keep:true, sync:true}}): Keeps data marked as "keep" for future watchers; share synchronously.', function testDataHub_keepSyncShare_SWS() {
            var watcher = new Watcher();
    ...
    describe("share, then share again, then watch (SSW)", function () {
        it('.share ({data: ...}): Doesn\'t "keep" data or "sync".', function testDataHub_dontKeepAsyncShare_SSW() {
            var watcher = new Watcher();
    ...
    describe("share, then watch, then share again; queued (SWSQ)", function () {
        it('.share ({data: ...}): Doesn\'t "keep" data or "sync"; share asynchronously, queued', function testDataHub_dontKeepAsyncShare_SWSQ() {
            var watcher = new Watcher();
    ...
    describe("share, then share again, then watch; queued (SSWQ)", function () {
        it('.share ({data: ...}): Doesn\'t "keep" data or "sync"; share asynchronously, queued.', function testDataHub_dontKeepAsyncShare_SSWQ() {
            var watcher = new Watcher();
    ...
    describe("Test arrays of watchers/shares", function testDataHub_arraysOfSharesAndWatchers() {
        ...
        it(".observe ([[{data: watcher}, {sync: true}],[{data: watcher2}]]):  Test an array of watchers that have different options.", function testDataHub_arrayOfWatches() {
            var watcher = new Watcher("Watcher One");
            var watcher2 = new Watcher("Watcher Two");
        ...
        it(".observe({data: [watcher, watcher2], data2: watcher}): Test an array of watchers in a normal watch map.", function testDataHub_arrayInWatchMap() {
            var watcher = new Watcher("Watcher One"),
        ...
        it(".observe[[{data: [watcher, watcher2]}],[{data2: watcher}]]): Test an array of watchers in an array in a normal watch map.", function testDataHub_arrayOfArrayInWatchMap() {
            var watcher = new Watcher("Watcher One"),
                watcher2 = new Watcher("Watcher Two");
